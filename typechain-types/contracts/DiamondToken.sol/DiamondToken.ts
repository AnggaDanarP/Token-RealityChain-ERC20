...
export interface DiamondTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdropToken"
      | "allowance"
...
export interface DiamondToken extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondToken;
  waitForDeployment(): Promise<this>;

  interface: DiamondTokenInterface;
  ...
  filters: {
    "AirdropToken(address,uint256)": TypedContractEvent<
      AirdropTokenEvent.InputTuple,
      AirdropTokenEvent.OutputTuple,
      AirdropTokenEvent.OutputObject
    >;
